    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your store catalog with advanced tools.
          </p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <Button
            className="bg-secondary text-secondary-foreground hover:bg-secondary/90 font-bold ml-auto sm:ml-0"
            onClick={() => {
      ...
      <Card className="shadow-sm">
        <CardContent className="p-4 flex flex-col xl:flex-row gap-4 items-center justify-between">
          ...
          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3 w-full xl:w-auto">
            ...
            <div className="flex border rounded-lg overflow-hidden shrink-0 ml-auto sm:ml-0">
              <Button
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 bg-muted/20 rounded-xl border-2 border-dashed mx-auto w-full">
        ...
        <div className="border rounded-lg bg-white shadow-sm overflow-x-auto scrollbar-thin">
                ...
                {data?.products.map((product) => (
                  <TableRow key={product.id} className="hover:bg-muted/30">
                    ...
                    <TableCell>
                      <Badge
                        variant="outline"
                        className="capitalize border-primary/20 text-primary/80"
                      >
                        {product.category}
                      </Badge>
                    </TableCell>
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-[160px] bg-white">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem onClick={onDelete} variant='destructive' className="text-destructive focus:text-destructive">
